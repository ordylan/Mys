...
长远规划很重要, 例如管理学科就是后加的, 特别麻烦! 动态更新存档还未完成, 也是旧版本遗留问题太多不好修!

最后总结出最节约事件的workflow: 项目起始全让ai写, 觉得形状可以后让ai进一步改. 当ai改坏后,不要继续让他改,后面全部自己改(哪怕你让ai写片段你自己复制进去)! 永远不要让ai改长代码! 要不然很有可能会无意碰坏已有功能!
